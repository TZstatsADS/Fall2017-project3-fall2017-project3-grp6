...
##Note we are not using GBM anymore because it takes so long time to run. We know at this point that we only have half an hour to run our code and get the result in class. As a result we stop using GBM anymore. 
###GBM, see you in the future.
####Make HoG dataset
```{r}
